...
class Adapter_Schedule extends RecyclerView.Adapter<Adapter_Schedule.ViewHolder> {
    ...
    public Adapter_Schedule(List<String> array_time, List<String> array_title, List<String> array_venue, List<String> array_description, List<String> array_speaker, List<String> array_profile, String track) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(track.equals( "1")){
            ...
            header.setBackgroundDrawable( context.getResources().getDrawable(R.drawable.header_technology) );

        }

        if(track.equals( "2")){

            header.setBackgroundDrawable( context.getResources().getDrawable(R.drawable.header_startup) );

        }
        if(track.equals("3")){

            header.setBackgroundDrawable( context.getResources().getDrawable(R.drawable.header_business) );

        }
        if(track.equals("4")){

            header.setBackgroundDrawable( context.getResources().getDrawable(R.drawable.header_innovation) );
